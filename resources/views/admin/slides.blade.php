                        ...
                        <tbody>
                            @foreach ($slides as $slide)
                                <tr>
                                    ...
                                    <td class="text-wrap text-break">{{ $slide->tagline }}</td>
                                    <td class="text-wrap text-break">{{ $slide->title }}</td>
                                    <td class="text-wrap text-break">{{ $slide->subtitle }}</td>
                                    <td class="text-wrap text-break">{{ $slide->link }}</td>
