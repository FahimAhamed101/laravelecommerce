        ...
        <div class="main-content-wrap">
            ...
            <div class="wg-box ">
                <form class="tf-section-2 form-add-product "
                    action=" {{ route('admin.slide.update') }} " method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            ...
                            <div class="item" id="imgpreview">
                                <img src="{{asset('uploads/slides')}}/{{$slide->image}}" alt="{{$slide->title}}" class="effect" />
                            </div>
                            @endif
                    ...
                    <div class="bot">
                        <div></div>
                        <button class="tf-button w208" type="submit">Updated</button>
                    </div>
                </form>
            </div>
            <!-- /new-category -->
