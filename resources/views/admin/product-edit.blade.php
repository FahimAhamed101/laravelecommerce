...
@section('content')
    <div class="main-content-inner">
        ...
        <div class="main-content-wrap">
            ...
            <!-- form-add-product -->
            <form class="tf-section-2 form-add-product" action="{{ route('admin.product.update') }}" method="POST"
                        ...
                        <div class="upload-image flex-grow">
                            @if ($product->image)
                                <div class="item" id="imgpreview">
                                    <img src="{{ asset('uploads/products') }}/{{ $product->image }}" id="imgpreview"
                    ...
                    <div class="cols gap22">
                        ...
                        <fieldset class="name">
                            ...
                            <input class="mb-10" type="text" placeholder="Enter quntity" name="quntity"
                                tabindex="0" value="{{ $product->quntity }}" aria-required="true" required="">
                        </fieldset>
                        @error('quntity')
                            <span class="alert alert-danger text-center">{{ $message }}</span>
                        @enderror
