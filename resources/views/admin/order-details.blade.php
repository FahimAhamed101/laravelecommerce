                        ...
                        <div class="col-md-3">
                            <div class="select">
                                <select name="order_status" id="order_status">
                                    <option value="ordered"{{ $orders->status == 'ordered' ? 'seleced' : '' }}>Ordered
                                    </option>
                                    <option value="delivered" {{ $orders->status == 'delivered' ? 'seleced' : '' }}>
                                        Delivered
                                    </option>
                                    <option value="canceled" {{ $orders->status == 'canceled' ? 'seleced' : '' }}>Canceled
                                    </option>
