...
<body class="body">
                ...
                if (searchQuery.length > 2) {
                    $.ajax({
                        ...
                        success: function(data) {
                            $("#box-content-search").html(''); // مسح النتائج السابقة
                            if (data.length === 0) {
                                $("#box-content-search").append(
                                    '<li class="text-muted">No results found</li>');
                                return;
                            }
    ...
    <li class="product-item gap14 mb-10">
        <div class="image no-bg">
            <img src="{{ asset('uploads/products/thumbnails') }}/${item.image}" alt="${item.name}"   href="${link}">
        </div>
